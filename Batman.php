...
<script src="https://cdn.jsdelivr.net/npm/bootstrap@5.3.0-alpha3/dist/js/bootstrap.bundle.min.js" integrity="sha384-ENjdO4Dr2bkBIFxQpeoTz1HIcje39Wm4jDKdf19U8gI4ddQ3GYNS7NTKfAdVQSZe" crossorigin="anonymous"></script>
    ...
    <div class="container-sm" >
      <div class="media d-flex align-items-center mb-5">
        <?php
          ...
          $sql="Select * from peliculas where linkPagina='Batman.php'";
          ...
          while($row =$result->fetch_assoc()) {
            ...
            <div class="media-body ms-3">
              <h5 style="color: #D0DDE8">Batman</h5>
              <p style="color: #D0DDE8"> <span style="color: #E7E739"> Año: </span> 2022  </p>
              <p style="color: #D0DDE8"> <span style="color: #E7E739"> Dirección: </span> Matt Reeves</p>
              <p style="color: #D0DDE8"> <span style="color: #E7E739"> Duración: </span> 179 minutos</p>
              <p style="color: #D0DDE8"> <span style="color: #E7E739"> Productora: </span> Warner Bros</p>
              <p style="color: #D0DDE8"> <span style="color: #E7E739">Sinopsis: </span> Batman se enfrenta al acertijo.</p>
            </div>
      </div>
    </div>
    ...
    <span class=" mt-5 placeholder col-12 mb-3" style="color:#201B6B"></span>
                 ...
                 <div class="justify-content-center text-center mt-5 ">
                     <IFRAME SRC="https://www.plusto.link/v/2dzl7b2xply6kll" FRAMEBORDER=0 MARGINWIDTH=0 MARGINHEIGHT=0 SCROLLING=NO WIDTH=75% HEIGHT=450px allowfullscreen></IFRAME>
                 </div>

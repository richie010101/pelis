        ...
        <?php
          ...
          while($row =$result->fetch_assoc()) {
            ...
            <div class="media-body ms-3">
              <h5 style="color: #D0DDE8">Morbius</h5>
              <p style="color: #D0DDE8"> <span style="color: #E7E739"> Año: </span> 2022  </p>
              <p style="color: #D0DDE8"> <span style="color: #E7E739"> Dirección: </span> Daniel Espinosa</p>
              <p style="color: #D0DDE8"> <span style="color: #E7E739"> Duración: </span> 108 minutos</p>
              <p style="color: #D0DDE8"> <span style="color: #E7E739"> Productora: </span> SONY</p>
              <p style="color: #D0DDE8"> <span style="color: #E7E739">Sinopsis: </span> Morbius, un doctor que tras sufrir una enfermedad en la sangre y fallar al intentar curarse, se convirtió en un vampiro.</p>
            </div>
      </div>
    </div>

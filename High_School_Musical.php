        ...
        <?php
          ...
          while($row =$result->fetch_assoc()) {
            ...
            <div class="media-body ms-3">
              <h5 style="color: #D0DDE8">High School Musical</h5>
              <p style="color: #D0DDE8"> <span style="color: #E7E739"> Año: </span> 2006  </p>
              <p style="color: #D0DDE8"> <span style="color: #E7E739"> Dirección: </span> Kenny Ortega</p>
              ...
              <p style="color: #D0DDE8"> <span style="color: #E7E739">Sinopsis: </span>Troy y Gabriella se enamoran </p>
            </div>
      </div>
    </div>
      ...
      <span class=" mt-5 placeholder col-12 mb-3" style="color:#201B6B"></span>
             ...
             <div class="">
                    ...
                    <div class="card-body" style="background-color: #111c30">
                        ...
                        <a href="apoyo.php" class="btn btn-secondary">¡Deja tus recomendaciones para la pagina!</a>
                    </div>
            </div>
     </body>
 </html>

        ...
        <?php
          ...
          while($row =$result->fetch_assoc()) {
            ...
            <div class="media-body ms-3">
              <h5 style="color: #D0DDE8">Uncharted</h5>
              <p style="color: #D0DDE8"> <span style="color: #E7E739"> Año: </span> 2022  </p>
              <p style="color: #D0DDE8"> <span style="color: #E7E739"> Dirección: </span> Ruben Fleischer</p>
              <p style="color: #D0DDE8"> <span style="color: #E7E739"> Duración: </span> 116 minutos</p>
              <p style="color: #D0DDE8"> <span style="color: #E7E739"> Productora: </span> Warner Bros</p>
              <p style="color: #D0DDE8"> <span style="color: #E7E739">Sinopsis: </span> Victor Sullivan recluta a Nathan Drake para que lo ayude a recuperar una fortuna</p>
            </div>
      </div>
    </div>

    ...
    <div class="container-sm" >
      <div class="media d-flex align-items-center mb-5">
        <?php
          ...
          $sql="Select * from peliculas where linkPagina='Shrek.php'";
          ...
          while($row =$result->fetch_assoc()) {
            ...
            <div class="media-body ms-3">
              <h5 style="color: #D0DDE8">Shrek</h5>
              <p style="color: #D0DDE8"> <span style="color: #E7E739"> Año: </span> 2001  </p>
              ...
              <p style="color: #D0DDE8"> <span style="color: #E7E739">Sinopsis: </span> Shrek un ogro emprende una aventura para rescatar una princesa</p>
            </div>
      </div>
    </div>
      ...
      <span class=" mt-5 placeholder col-12 mb-3" style="color:#201B6B"></span>
                 ...
                 <div class="justify-content-center text-center mt-5 ">
                     <IFRAME SRC="https://uqload.com/embed-nbronni52rna.html" FRAMEBORDER=0 MARGINWIDTH=0 MARGINHEIGHT=0 SCROLLING=NO WIDTH=75% HEIGHT=450px allowfullscreen></IFRAME>
                 </div>

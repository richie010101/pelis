...
<head>
    ...
    <title>Barbie_Puerta_Secreta</title> 
    <?php
...
<script src="https://cdn.jsdelivr.net/npm/bootstrap@5.3.0-alpha3/dist/js/bootstrap.bundle.min.js" integrity="sha384-ENjdO4Dr2bkBIFxQpeoTz1HIcje39Wm4jDKdf19U8gI4ddQ3GYNS7NTKfAdVQSZe" crossorigin="anonymous"></script>
    ...
    <div class="container-sm" >
      <div class="media d-flex align-items-center mb-5">
        <?php
          ...
          $sql="Select * from peliculas where linkPagina='barbie.php'";
          ...
          while($row =$result->fetch_assoc()) {
            ...
            <div class="media-body ms-3">
              <h5 style="color: #D0DDE8">Barbie la Puerta Secreta</h5>
              <p style="color: #D0DDE8"> <span style="color: #E7E739"> Año: </span> 2014  </p>
              <p style="color: #D0DDE8"> <span style="color: #E7E739"> Dirección: </span> Karen Lloyd</p>
              <p style="color: #D0DDE8"> <span style="color: #E7E739"> Duración: </span> 90 minutos</p>
              <p style="color: #D0DDE8"> <span style="color: #E7E739"> Productora: </span> Mattel Films</p>
              <p style="color: #D0DDE8"> <span style="color: #E7E739">Sinopsis: </span> La princesa Alexa descubre una puerta secreta y entra en una tierra desconocida.</p>
            </div>
      </div>
    </div>
    ...
    <span class=" mt-5 placeholder col-12 mb-3" style="color:#201B6B"></span>
      ...
      <div class="justify-content-center text-center mt-5  ">
        <IFRAME SRC="https://uqload.com/embed-f6e7g1epb2hp.html" class="" MARGINWIDTH=0 MARGINHEIGHT=0 SCROLLING=NO WIDTH=700 HEIGHT=470 allowfullscreen></IFRAME>
      </div>

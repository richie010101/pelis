    ...
    <div class="container-sm" >
      <div class="media d-flex align-items-center mb-5">
        <?php
          ...
          $sql="Select * from peliculas where linkPagina='Sonic_2.php'";
          ...
          while($row =$result->fetch_assoc()) {
            ...
            <div class="media-body ms-3">
              <h5 style="color: #D0DDE8">Sonic 2</h5>
              <p style="color: #D0DDE8"> <span style="color: #E7E739"> Año: </span> 2022  </p>
              <p style="color: #D0DDE8"> <span style="color: #E7E739"> Dirección: </span> Jeff Fowler</p>
              <p style="color: #D0DDE8"> <span style="color: #E7E739"> Duración: </span> 100 minutos</p>
              <p style="color: #D0DDE8"> <span style="color: #E7E739"> Productora: </span> Dreamworks</p>
              <p style="color: #D0DDE8"> <span style="color: #E7E739">Sinopsis: </span> Sonic y compañía emprenden un viaje</p>
            </div>
      </div>
    </div>
      ...
      <span class=" mt-5 placeholder col-12 mb-3" style="color:#201B6B"></span>
            ...
            <div class="justify-content-center text-center mt-5 ">
                     <IFRAME SRC="https://mega.nz/embed/leVX1KSZ#1sbg6b4LwqF3UkiXRWuEpFZiMG2K6fIiZEq77541hSM" FRAMEBORDER=0 MARGINWIDTH=0 MARGINHEIGHT=0 SCROLLING=NO WIDTH=75% HEIGHT=600px allowfullscreen></IFRAME>

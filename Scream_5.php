        ...
        <?php
          ...
          while($row =$result->fetch_assoc()) {
            ...
            <div class="media-body ms-3">
              <h5 style="color: #D0DDE8">Scream 5</h5>
              <p style="color: #D0DDE8"> <span style="color: #E7E739"> Año: </span> 2022  </p>
              <p style="color: #D0DDE8"> <span style="color: #E7E739"> Dirección: </span> Tyler Gillet</p>
              <p style="color: #D0DDE8"> <span style="color: #E7E739"> Duración: </span> 114 minutos</p>
              <p style="color: #D0DDE8"> <span style="color: #E7E739"> Productora: </span>  Blum House</p>
              <p style="color: #D0DDE8"> <span style="color: #E7E739">Sinopsis: </span>Ghostface regresa para aterrorizar</p>
            </div>
      </div>
    </div>

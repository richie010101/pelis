...
<script src="https://cdn.jsdelivr.net/npm/bootstrap@5.3.0-alpha3/dist/js/bootstrap.bundle.min.js" integrity="sha384-ENjdO4Dr2bkBIFxQpeoTz1HIcje39Wm4jDKdf19U8gI4ddQ3GYNS7NTKfAdVQSZe" crossorigin="anonymous"></script>
        ...
        <?php
          ...
          while($row =$result->fetch_assoc()) {
            ...
            <div class="media-body ms-3">
              <h5 style="color: #D0DDE8">Chip y Dale</h5>
              <p style="color: #D0DDE8"> <span style="color: #E7E739"> Año: </span> 2022  </p>
              <p style="color: #D0DDE8"> <span style="color: #E7E739"> Dirección: </span> Akiva Schaffer</p>
              <p style="color: #D0DDE8"> <span style="color: #E7E739"> Duración: </span> 97 minutos</p>
              <p style="color: #D0DDE8"> <span style="color: #E7E739"> Productora: </span> Disney</p>
              <p style="color: #D0DDE8"> <span style="color: #E7E739">Sinopsis: </span> Chip y Dale se embarcan en una aventura epica para salvar el entretenimiento.</p>
            </div>
      </div>
    </div>
    ...
    <span class=" mt-5 placeholder col-12 mb-3" style="color:#201B6B"></span>
        <div class="justify-content-center text-center mt-5 ">
                     <IFRAME SRC="https://mega.nz/embed/1G1nzZzB#VuYOs-Ql0_ftp3RlMYzPusMnj40Wy79RgxCJAXb7_lM" FRAMEBORDER=0 MARGINWIDTH=0 MARGINHEIGHT=0 SCROLLING=NO WIDTH=700 HEIGHT=470 allowfullscreen></IFRAME>
        </div>
